import { SymaREPL } from '@syma/cli/repl/repl';
...
export class NotebookEngine {
    ...
    async initialize() {
        ...
        // Set up notebook-specific commands wrapper
        this.notebookCommands = new NotebookCommands(this.repl);
        // Keep the original command processor and wrap it
        this.notebookCommands.originalCommandProcessor = this.repl.commandProcessor;
        this.repl.commandProcessor = this.notebookCommands;
