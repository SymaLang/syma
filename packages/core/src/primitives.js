...
function foldProjectToString(args, context) {
    if (!context || !context.universe || !context.normalizeFunc || !context.extractRulesFunc || !context.renderToString) {
        ...
        // or when renderToString function is not injected
        return null;
    }
